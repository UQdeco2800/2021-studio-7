...
class ResourceServiceTest {
    ...
    void loadAllShouldLoadUnloadAssets() {
        ...
        resourceService.loadAssets(textures, Texture.class);
    ...
    void shouldContainAndGetAssets() {
        ...
        verify(assetManager, times(2)).contains(texture1, Texture.class);
        verify(assetManager, times(2)).contains(texture2, Texture.class);
    ...
    void shouldLoadTextureAtlases() {
        ...
        resourceService.loadAssets(textures, TextureAtlas.class);
    ...
    void shouldLoadSounds() {
        ...
        resourceService.loadAssets(textures, Sound.class);
    ...
    void shouldLoadMusic() {
        ...
        resourceService.loadAssets(textures, Music.class);
