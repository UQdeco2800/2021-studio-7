...
class TouchAttackComponentTest {
  ...
  void shouldAttack() {
    ...
    entity.getEvents().trigger("collision_start", entityFixture, targetFixture);
  ...
  Entity createAttacker(short targetLayer) {
    Entity entity =
        new Entity()
            ...
            .addComponent(new CombatStatsComponent(0, 10, 0)) //todo stamina
            .addComponent(new PhysicsComponent())
  ...
  Entity createTarget(short layer) {
    Entity target =
        new Entity()
            .addComponent(new CombatStatsComponent(10, 0, 10)) //TODO: stamina
            .addComponent(new PhysicsComponent())
