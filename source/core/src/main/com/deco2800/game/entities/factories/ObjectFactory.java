...
public class ObjectFactory {
  ...
  public static Entity createWall(String[] assets) {
    ...
    Entity wall = createBaseObject(assets, BodyType.StaticBody);
...
//            .addComponent(new DoorActions());
  ...
  public static Entity createBath(String[] assets) {
    Entity bath = createBaseObject(assets, BodyType.StaticBody);
  ...
  public static Entity createCoffeeTable(String[] assets) {
    Entity coffeeTable = createBaseObject(assets, BodyType.StaticBody);
  ...
  public static Entity createSideTable(String[] assets) {
    Entity side = createBaseObject(assets, BodyType.StaticBody);
  ...
  public static Entity createBin(String[] assets) {
    Entity bin = createBaseObject(assets, BodyType.StaticBody);
  ...
  public static Entity createBaseInteractable(String[] assets, BodyType bodyType) {
    ...
    Entity interactable = createBaseObject(assets, bodyType)
            .addComponent(new HitboxComponent().setLayer(PhysicsLayer.OBSTACLE));
    PhysicsUtils.setScaledHitbox(interactable, 1f, 1f);
    return interactable;
  }

  public static Entity createBaseObject(String[] assets, BodyType bodyType) {
