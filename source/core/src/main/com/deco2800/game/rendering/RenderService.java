...
public class RenderService implements Disposable {
    ...
    private static final Comparator<Actor> comparator = (o1, o2) -> {
        try {
            TableUserData tableData1 = (TableUserData) o1.getUserObject();
            TableUserData tableData2 = (TableUserData) o2.getUserObject();
            return (int) ((tableData1.getRenderPriority() - tableData2.getRenderPriority()) * 100);
    ...
    public static class TableUserData {
        ...
        public TableUserData(float renderPriority) {
